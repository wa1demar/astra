			...
			<div class="topbar-right pull-right">
				<ul class="topbar-elements">
					...
					<li class="topbar-search">
						<a href="javascript:void(0)"><i class="search-icon fa fa-search"></i><span><?php esc_html_e( 'Search', 'codilight-lite' ); ?>111</span></a>
...
<p style="float:left; margin-top:-30px;"><img src="/wp-content/themes/astradia/assets/images/astra-logo.png"></br></br><a href="#" class="button7">Результати онлайн</a></p>
				<?php
