				...
				<main id="main" class="site-main" role="main">
					...
					<section class="error-404 not-found">
						<header class="page-header">
							<h1 class="page-title"><?php esc_html_e( 'Нажаль, але нічого не знайдено', 'codilight-lite' ); ?></h1>
							<h3 class="page-subtitle"><?php esc_html_e( 'Спробуйте знову повторити свій запит, або почніть з головної сторінки', 'codilight-lite' ); ?></h3>
						</header><!-- .page-header -->

						<div class="page-content">
							<div class="search404">
								<p><?php esc_html_e( 'Можливо потрібен пошук?', 'codilight-lite' ); ?></p>
								<?php get_search_form(); ?>
							</div>

							<div class="latest-posts-404">
								<h4><?php esc_html_e( 'Остані записи', 'codilight-lite' ); ?></h4>
								<?php
